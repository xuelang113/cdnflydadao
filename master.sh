...
cd /opt/
download "https://github.com/xuelang113/cdnflydadao/raw/main/master/$tar_gz_name" "https://github.com/xuelang113/cdnflydadao/raw/main/master/$tar_gz_name" "$tar_gz_name"
